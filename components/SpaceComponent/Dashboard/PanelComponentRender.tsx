...
export const PanelComponentRender = ({
    panelComponent,
}: {
    ...
    return (
        <div key={panelComponent.id} className="mb-4 flex w-full justify-between">
            <div className="flex flex-col items-center rounded-lg border px-8 py-4 shadow-lg">
                ...
                <TrashIcon
                    ...
                    onClick={() => deletePanelComponent.mutate({ where: { id: panelComponent.id } })}
                />
            </div>
        </div>
    );
